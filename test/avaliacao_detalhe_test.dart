...
void main() {
  testWidgets('teste widget', (WidgetTester tester) async {
    ...
    //final floatingg = find.byKey(ValueKey("pdf"));

    //Encontrando um text
    //expect(find.byKey(ValueKey("Nome projeto")), findsOneWidget);
    expect(find.text('teste'), findsOneWidget);
    //await tester.tap(floatingg);
    // expect(floatingg, findsOneWidget);
